...
class BasicConv3d(nn.Module):
    def __init__(self, in_planes, out_planes, kernel_size, stride, padding=0):
        ...
        self.block = [self.conv, self.bn, self.relu]
...
class Mixed_5b(nn.Module):
    def __init__(self):
        ...
        self.block = [self.branch0, self.branch1, self.branch2, self.branch3]
...
class Block35(nn.Module):
    def __init__(self, scale=1.0):
        ...
        self.block = [self.branch0, self.branch1, self.branch2, self.conv3d, self.relu]
...
class Mixed_6a(nn.Module):
    def __init__(self):
        ...
        self.block = [self.branch0, self.branch1, self.branch2]
...
class Block17(nn.Module):
    def __init__(self, scale=1.0):
        ...
        self.block = [self.branch0, self.branch1, self.conv3d, self.relu]
